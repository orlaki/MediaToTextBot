...
def send_welcome(message):
    if ensure_joined(message):
        bot.reply_to(message, "👋 **Salaam!**\nSend me audio/video/voice to transcribe.", parse_mode="Markdown")
...
def mode_cb(call):
    ...
    bot.edit_message_text(f"Output mode: **{mode}**", call.message.chat.id, call.message.message_id, parse_mode="Markdown")
