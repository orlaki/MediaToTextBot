...
# Kani waa dictionary-ga lagu kaydinayo tirada isticmaalka model-ka ee user kasta
user_model_usage = {}
MAX_USAGE_COUNT = 18
...
def get_current_model(uid):
    ...
    # Haddii xaalad lama filaan ah dhacdo, ku bilow kan aasaasiga ah
...
<div class="container">
  <div class="header">
    ...
    <div>
      ...
      <div class="subtitle">Transcribe voice, audio and video from Telegram. Translate, summarize and download clean transcripts.</div>
    </div>
  </div>
  <div class="grid">
    <div class="card hero">
      ...
      <p class="note">Send voice messages, audio files or videos in Telegram to get a clean transcription. Optionally provide a Gemini API key (starts with <strong>AIz</strong>) to enable on-demand language understanding, translation and summarization powered by Gemini.</p>
      <div class="features">
        <div class="feature">
        ...
        <div class="feature">
          <strong>Translate & Summarize</strong>
          <div class="note">Translate into many languages and produce short, detailed or bulleted summaries.</div>
        </div>
        <div class="feature">
      ...
      <div class="steps">
        ...
        <div class="step"><div class="num">2</div><div><strong>Provide a Gemini key (optional)</strong><div class="note">Send a message that begins with your Gemini API key (AIz... ). This unlocks translation & summarization features.</div></div></div>
        ...
        <div class="step"><div class="num">4</div><div><strong>Use actions</strong><div class="note">After transcription use the inline buttons to translate or summarize results.</div></div></div>
      </div>
