...
def send_promo(chat_id):
    promo_text = (
        "Upgrade Your Speech-to-Text! 🚀\n\n"
        "• High Quality: Get accurate, clean transcripts powered by Gemini AI.\n"
        "• Advanced Features: Easily Summarize and Translate your text instantly.\n"
        "• File Limit: Send larger files (up to 500MB).\n\n"
        "Switch to @MediaToTextBot Now!"
    )
    bot.send_message(chat_id, promo_text)
